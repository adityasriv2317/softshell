                    ...
                    <div className="grid gap-2">
                      {exampleQuestions.map((question, index) => (
                        <motion.button
                          ...
                          className="w-full text-left px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg text-gray-700 dark:text-gray-300 text-sm transition-colors duration-200"
                        >
                          {question}
                        </motion.button>
                      ))}
