...
import { Shield, Clock, Users, TrendingUp, LineChart, BarChart, PieChart, Activity } from 'lucide-react';
...
const WhyUs = () => {
  const features = [
    ...
    },
    {
      icon: Clock,
      title: 'Fast Process',
      description: 'Complete transactions within 48 hours with instant payment options.',
      color: 'blue',
      delay: 0.3
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Experience the difference with our comprehensive software license resale platform
          </p>
        </motion.div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 h-full">
                <div className={`w-16 h-16 rounded-2xl bg-${feature.color}-100 dark:bg-${feature.color}-900/20 flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform duration-300 mx-auto`}>
